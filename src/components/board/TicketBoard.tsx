import { Columns3, GripVertical, MessageSquare, Paperclip, Plus } from "lucide-react";
      ...
      <div className="bevel-panel m-3 rounded-[1.35rem] p-4">
        <div className="flex flex-wrap items-end justify-between gap-3">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <p className="mr-1 text-sm text-desk-muted">
        ...
        <p className="mt-3 flex items-center gap-2 text-xs text-desk-muted">
          ...
          <div className="grid h-full min-w-[78rem] grid-cols-7 gap-3">
            {boardStatuses.map((status) => {
              ...
              return (
                ...
                >
                  <div className="flex shrink-0 items-center justify-between border-b border-desk-border/60 px-3 py-3">
...
function BoardTicketCard({
  ...
  return (
    <button
      className={`board-card-bevel group cursor-grab rounded-2xl p-3 text-left transition active:cursor-grabbing hover:-translate-y-0.5 hover:border-desk-accent/45 hover:shadow-[0_18px_32px_rgba(78,68,49,0.12)] ${
        dragging ? "opacity-50" : ""
